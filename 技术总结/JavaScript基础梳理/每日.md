...
var child1 = new Child();  // { a:2, b:[8,2,9], c:{demo:4} }
var child2 = new Child(); // { a:2, b:[8,2,9], c:{demo:4} }
...
child1.change();  // b:[8, 2, 9, 11] a:4+1=5 c.demo:4 
child2.change();  // 6 [8, 2, 9, 11, 12] 5

parent.show();  // 9 [8, 2, 9] 4
child1.show();  // 4 [8, 2, 9, 11, 12] 5
child2.show();  // 5 [8, 2, 9, 11, 12] 5
```